                ...
                function crypto_obj() {
                    ...
                    return {
                        encrypt: function(data, key, options) {
                            ...
                            var encryptedHexArray = CryptoJS["AES"]["encrypt"
                            ](hex_message, cipher_key, { iv: iv, mode: mode })["ciphertext"];
                        ...
                        decrypt: function(data, key, options) {
                            ...
                            try {
                                ...
                                ]({ ciphertext: binary_enc }, cipher_key, { iv: iv, mode: mode })["toString"
                                ](CryptoJS["enc"]["Utf8"]);
...
/***/ function(module, exports) {
                        ...
                        var f = {},
                            ...
                            m = g.Base = {
                                extend: function(a) {
                                    ...
                                    (c.init = function() { c.$super.init.apply(this, arguments) });
                                    c.init.prototype = c;
                                    c.$super = this;
                                    return c
                                },
                            ...
                            n = l.Latin1 = {
                                ...
                                parse: function(a) {
                                    for (var c = a
                                             ...
                                             b = 0;
                                    b < c;
                                    b++) d[b >>> 2] |= (a.charCodeAt(b) & 255) << 24 - 8 * (b % 4);
                ...
                (function(h) {
                    for (var s = CryptoJS,
                             ...
                             m = [],
                             r = [],
                             l = function(a) { return 4294967296 * (a - (a | 0)) | 0 },
                             k = 2,
                             n = 0;
                    64 > n;
                    ) {
                            ...
                            _doProcessBlock: function(c, d) {
                                ...
                                p++) {
                                    ...
                                    k = q +
                                        ...
                                        r[p] +
                                        a[p];
                                    l = ((e << 30 | e >>> 2) ^ (e << 19 | e >>> 13) ^ (e << 10 | e >>> 22)) +
                                    (e & f ^ e & g ^ f & g);
                                    q = n;
                                    n = m;
                                    m = h;
                ...
                CryptoJS.lib.Cipher ||
                    function(u) {
                        ...
                        d.StreamCipher = v
                            .extend({ _doFinalize: function() { return this._process(!0) }, blockSize: 1 });
                        var b = p.mode = {},
                            x = function(e, a, b) {
                                var c = this._iv;
...
/***/ function(module, exports, __webpack_require__) {
                    ...
                    return function(origin, failover) {
                        return origin.indexOf("pubsub.") > 0 &&
                            origin.replace(
                                ...
                                "ps" +
                                (
                                    failover ? utils.generateUUID().split("-")[0] : (++ori < max ? ori : ori = 1)
                                )) ||
                            origin;
                    };
                })();
                ...
                function generate_channel_group_list(channel_groups, nopresence) {
                    var list = [];
                    utils.each(channel_groups,
                        function(channel_group, status) {
                            if (nopresence) {
                ...
                function PN_API(setup) {
                    ...
                    var PRESENCE_HB = validate_presence_heartbeat(
                        setup["heartbeat"] || setup["pnexpires"] || 0,
                        setup["error"]
                    );
                    ...
                    var UUID = setup["uuid"] ||
                    (!setup["unique_uuid"] && db && db["get"](SUBSCRIBE_KEY + "uuid") || ""
                    );
                    ...
                    var use_send_beacon = (typeof setup["use_send_beacon"] != "undefined")
                        ? setup["use_send_beacon"
                        ]
                        : true;
                    ...
                    function validate_presence_heartbeat(heartbeat, cur_heartbeat, error) {
                        ...
                        if (err) {
                            error &&
                                error("Presence Heartbeat value invalid. Valid range ( x > " +
                                    PRESENCE_HB_THRESHOLD +
                                    " or x = 0). Current Value : " +
                                    (cur_heartbeat || PRESENCE_HB_THRESHOLD));
                    ...
                    function _presence_heartbeat() {
                        ...
                        if (!PRESENCE_HB_INTERVAL ||
                            PRESENCE_HB_INTERVAL >= 500 ||
                            PRESENCE_HB_INTERVAL < 1 ||
                            (!generate_channel_list(CHANNELS, true).length &&
                                !generate_channel_group_list(CHANNEL_GROUPS, true).length)) {
                        ...
                        SELF["presence_heartbeat"]({
                            callback: function(r) {
                                PRESENCE_HB_TIMEOUT = utils
                                    .timeout(_presence_heartbeat, (PRESENCE_HB_INTERVAL) * SECOND);
                            },
                            error: function(e) {
                                error &&
                                    error("Presence Heartbeat unable to reach Pubnub servers." +
                                        JSON
                                        .stringify(e));
                                PRESENCE_HB_TIMEOUT = utils
                                    .timeout(_presence_heartbeat, (PRESENCE_HB_INTERVAL) * SECOND);
                    ...
                    function each_channel_group(callback) {
                        ...
                        utils.each(generate_channel_group_list(CHANNEL_GROUPS),
                    ...
                    function each_channel(callback) {
                        ...
                        utils.each(generate_channel_list(CHANNELS),
                            function(channel) {
                    ...
                    */
                    ...
                    var SELF = {
                        LEAVE: function(channel, blocking, auth_key, callback, error) {
                            ...
                            if (sendBeacon) {
                                ...
                                if (sendBeacon(url_string)) {
                                    callback &&
                                        callback({ status: 200, action: "leave", message: "OK", service: "Presence" });
                                    return true;
                                }
                            }
                        ...
                        channel_group_remove_group: function(args, callback) {
                            if (!args["channel_group"]) return error("Missing Channel Group");
                            if (args["channel"])
                                return error("Use channel_group_remove_channel if you want to remove a channel from a group.");
                                    ...
                                    for (var a = 0; a < messages.length; a++) {
                                        if (include_token) {
                                            ...
                                            try {
                                                ...
                                                ]({ message: JSON["parse"](new_message), timetoken: timetoken });
                                            } catch (e) {
                                                decrypted_messages["push"
                                                ](({ message: new_message, timetoken: timetoken }));
                                            }
                                        } else {
                        ...
                        unsubscribe: function(args, callback) {
                            ...
                            if (channelArg) {
                                ...
                                utils.each(existingChannels,
                                    function(channel) {
                                        presenceChannels.push(channel + PRESENCE_SUFFIX);
                                    });

                                utils.each(existingChannels.concat(presenceChannels),
                                    function(channel) {
                            ...
                            if (channelGroupArg) {
                                var channelGroups = utils.isArray(channelGroupArg)
                                    ? channelGroupArg
                                    : ("" + channelGroupArg).split(",");
                                var existingChannelGroups = [];
                                var presenceChannelGroups = [];

                                utils.each(channelGroups,
                                ...
                                // Prepare presence channels
                                utils.each(existingChannelGroups,
                                    function(channelGroup) {
                                        presenceChannelGroups.push(channelGroup + PRESENCE_SUFFIX);
                                    });

                                utils.each(existingChannelGroups.concat(presenceChannelGroups),
                                    function(channelGroup) {
                                ...
                                var CB_CALLED = true;
                                if (READY) {
                                    CB_CALLED = SELF["LEAVE_GROUP"
                                    ](existingChannelGroups.join(","), 0, auth_key, callback, err);
                                }
                                if (!CB_CALLED) callback({ action: "leave" });
                            }
                        ...
                        subscribe: function(args, callback) {
                            ...
                            if (channel_group) {
                                utils.each((channel_group.join ? channel_group.join(",") : "" + channel_group)
                                    .split(","),
                                    function(channel_group) {
                            ...
                            function _connect() {
                                ...
                                SUB_RECEIVER = executeRequest({
                                    ...
                                    success: function(messages) {
                                        // Check for Errors
                                        if (!messages ||
                                        (typeof messages == "object" && "error" in messages && messages["error"])) {
                                            SUB_ERROR(messages);
                                        ...
                                        TIMETOKEN = !TIMETOKEN && SUB_RESTORE && db["get"](SUBSCRIBE_KEY) ||
                                        messages[1
                                        ];
                                        ...
                                        var next_callback = (function() {
                                            ...
                                            return function() {
                                                ...
                                                if (channel2) {
                                                    ...
                                                    chobj =
                                                        CHANNEL_GROUPS[channel2] || CHANNELS[channel2] || default_chobj;
                                                } else {
                                        ...
                                        utils.each(messages[0],
                                            function(msg) {
                                                var next = next_callback();
                                                var decrypted_msg = decrypt(msg,
                                                (CHANNELS[next[1]]) ? CHANNELS[next[1]]["cipher_key"] : null);
                                                next[0] &&
                                                    next[0](decrypted_msg,
                                                        messages,
                                                        next[2] || next[1],
                                                        latency,
                                                        next[1]);
...
/***/ function(module, exports, __webpack_require__) {
                ...
                function isArray(arg) {
                    return !!arg &&
                        typeof arg !== "string" &&
                        (Array.isArray && Array.isArray(arg) || typeof(arg.length) === "number");
